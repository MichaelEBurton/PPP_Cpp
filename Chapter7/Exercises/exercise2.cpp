/*
    Exercise:
      Provide an asignment operator, =, so that you can change the value of a variable after you introducte it using let. 
      Discuss why that can be useful and how it can be a source of problems.
      > It can be useful because we may accidentally set the variable to a wrong value, which would be problematic if we 
          can't change the value.
      > This could be problematic since our result prompt is "= " if we were to mistype it we may run into errors.
