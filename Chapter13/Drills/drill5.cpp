/*
	...
	5. Add a 100-by-100 image. Have it move around from square to square when you click the "Next" button. Just 
...
int main()
{
	...
	//====================================================================================
	Image voyage{ Point{0,0}, "voyageurs.jpg" };
	voyage.set_mask(Point{ 800,500 }, 100, 100);
