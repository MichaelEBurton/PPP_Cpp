/*
    ...
    Purpose: Define an input operator (>>) that reads monetary amounts with currency denominations,
               such as USD1.23 and DKK5.00 into a Money variable. Also define a corresponding output
               operator (>>).

    Edited:  8/21/20 

    Notes: This is no different than exercises 14 and 15 as I had already implemented these.
